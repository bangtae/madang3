...
window.PORTAL_DATA_STOCK_COUNCIL = [
  {
    "id": "scr-20260908_114328-삼성전자-council",
    ...
    "grade": "적극매수",
    "summary": "- 판정: 적극매수 - 리스크: 4/10 - 진입: 256,500원 ~ 270,000원 구간에서 3회 분할 매수",
    "kStockTemp": {
      "temp": 60,
      "status": "🌤️ 온화/호조 (60°C)",
    ...
    "factData": {
      ...
      "avg20dVolume": "21278968주"
    },
    "subagentReports": {
      "growth": "현재가 270,000원 대비 컨센서스 목표주가 488,409원은 약 80.9%의 업사이드를 나타낸다. 핵심 테마는 '차세대 고대역폭 메모리(HBM) 및 AI 가속기 생태계'이며 본 종목은 [대장주 (주도주)] 역할을 수행한다. [한국경제 보도] 삼성 하반기 공채 스타트···삼성전자 등 19개사 참여 - 한경매거진&북가 실적 모멘텀을 견인하며 글로벌 AI 가속기 시장 연평균 30% 이상 성장 수혜로 중장기 확장이 가시화된다.",
      "cautious": "자산가치 대비 프리미엄이 붙어 있어 급격한 변동 장세에서 손실 위험이 있다. 세력 단계는 [1단계: 매집 (Accumulation - 인내의 구간)]로 추가 가격 조정 시점까지 보수적 관망을 권고한다. [실시간 뉴스 팩트 검증] 한국경제 보도('삼성 하반기 공채 스타트···삼성전자 등 19개사 참여 - 한경매거진&북')의 주가 선반영 여부 및 차익 실현 매물 출회 리스크를 면밀히 살펴야 합니다.",
      "technical": "기관(+4,568,427주)과 외국인(+3,246,247주)의 수급 흐름이 단기 변곡점을 형성하고 있다. 거래량 18,314,016주가 실리며 이전 고점 대비 매물 소화 과정이 진행 중이다. 주요 마디가(Key Levels) 1차 진입가는 264,600원이며, 거짓 돌파(Fakeout)를 방지하기 위해 지지선 확인 후 분할 진입이 유리하다.",
      "jurini": "한 번에 다 사지 말고, 주가가 조금 내릴 때마다 소액 분할 매수하세요."
    },
    "date": "2026-09-08",
    "time": "11:43:28",
    "createdAt": "2026-09-08T11:43:28.622315",
    "factCheck": {
      "status": "VERIFIED_CLEAN",
      "verifiedAt": "2026-09-08 11:43:28",
  ...
  {
    "id": "scr-20260908_114303-삼성전자-council",
    "agentId": "lead_stock_orchestrator",
    "persona": "AI 투자심의위원회 (메인총괄)",
    "icon": "⚖️",
    "role": "메인 주식 총괄 에이전트 / 팩트체크 감시자",
    ...
    "date": "2026-09-08",
    "time": "11:43:03",
    "createdAt": "2026-09-08T11:43:03.896899",
    "factCheck": {
      "status": "VERIFIED_CLEAN",
      "verifiedAt": "2026-09-08 11:43:04",
      "verifier": "LeadStockAuditor",
      "accuracyScore": 100,
      "badge": "🛡️ [Fact-Checked: 100% 팩트 인증]",
      "corrections": [],
  ...
  },
  {
    ...
    "date": "2026-09-08",
    "time": "11:43:03",
    "createdAt": "2026-09-08T11:43:03.257084",
    "factCheck": {
      "status": "VERIFIED_CLEAN",
      "verifiedAt": "2026-09-08 11:43:03",
      "verifier": "LeadStockAuditor",
      "accuracyScore": 100,
      "badge": "🛡️ [Fact-Checked: 100% 팩트 인증]",
      "corrections": [],
  ...
  {
    "id": "scr-20260908_114302-기아-council",
    "agentId": "lead_stock_orchestrator",
    "persona": "AI 투자심의위원회 (메인총괄)",
    "icon": "⚖️",
    "role": "메인 주식 총괄 에이전트 / 팩트체크 감시자",
    ...
    "grade": "적극매수",
    "summary": "- 판정: 적극매수 - 리스크: 3/10 - 진입: 121,980원 ~ 128,400원 구간에서 3회 분할 매수",
    "kStockTemp": {
      "temp": 60,
      "status": "🌤️ 온화/호조 (60°C)",
      "datetime": "2026-09-07 오전"
    ...
    "factData": {
      ...
      "avg20dVolume": "779513주"
    },
    "subagentReports": {
      "growth": "현재가 128,400원 대비 컨센서스 목표주가 216,800원은 약 68.8%의 업사이드를 나타낸다. 핵심 테마는 '개별 기업 펀더멘털 및 시장 자율 모멘텀'이며 본 종목은 [개별 주도주] 역할을 수행한다. [한국경제 보도] 기아, 2026 하반기 집중 채용 실시가 실적 모멘텀을 견인하며 신흥 시장 진출 및 구조적 수요 증가 사이클로 중장기 확장이 가시화된다.",
      "cautious": "PER 7.09배(요구수익률: 14.1%), PBR 0.77배 수준으로 자산 청산가치 대비 하방 지지력이 양호하다. 세력 운전 단계는 [1단계: 매집 (Accumulation - 인내의 구간)]로 추정되며, 작전 리스크는 1/5점 수준이다. 단칼 화수분 원칙에 따라 안정적인 잉여현금흐름과 배당 여력을 갖추었으나, 경기 침체 시 실적 둔화 가능성을 염두에 두고 철저한 분할 매수를 유지해야 한다. [실시간 뉴스 팩트 검증] 한국경제 보도('기아, 2026 하반기 집중 채용 실시')의 주가 선반영 여부 및 차익 실현 매물 출회 리스크를 면밀히 살펴야 합니다.",
      "technical": "기관(-30,636주)과 외국인(+46,829주)의 수급 흐름이 단기 변곡점을 형성하고 있다. 거래량 719,881주가 실리며 이전 고점 대비 매물 소화 과정이 진행 중이다. 주요 마디가(Key Levels) 1차 진입가는 125,832원이며, 거짓 돌파(Fakeout)를 방지하기 위해 지지선 확인 후 분할 진입이 유리하다.",
      "jurini": "용돈 생길 때마다 적금 붓듯이 3번에 나누어 사기 딱 좋은 구간입니다."
    },
    "date": "2026-09-08",
    "time": "11:43:02",
    "createdAt": "2026-09-08T11:43:02.951392",
    "factCheck": {
      "status": "VERIFIED_CLEAN",
      "verifiedAt": "2026-09-08 11:43:03",
      "verifier": "LeadStockAuditor",
  ...
  },
  {
    ...
    "grade": "중립",
    "summary": "- 판정: 중립 - 리스크: 8/10 - 진입: 724,850원 ~ 763,000원 구간에서 3회 분할 매수",
    "kStockTemp": {
      "temp": 50,
      "status": "미지근/중립 (50°C)",
      "datetime": ""
    ...
    "factData": {
      ...
      "avg20dVolume": "131527주"
    },
    "subagentReports": {
      "growth": "현재가 763,000원 대비 컨센서스 목표주가 1,181,000원은 약 54.8%의 업사이드를 나타낸다. 전방 산업 수주 잔고 증가 및 글로벌 수출 다변화가 단기 실적 모멘텀을 지지하며, 신흥 시장 진출 및 구조적 수요 증가 사이클로 중장기 매출 성장이 유효하다.",
      "cautious": "자산가치 대비 프리미엄이 붙어 있어 급격한 변동 장세에서 손실 위험이 있다. 추가 가격 조정 시점까지 보수적 관망을 권고한다.",
      "technical": "기관(+25,202주)과 외국인(+17,353주)의 수급 흐름이 단기 변곡점을 형성하고 있다. 거래량 92,183주가 실리며 이전 고점 대비 매물 소화 과정이 진행 중이므로, 지지선 이탈 여부를 확인하면서 눌림목 분할 진입이 유리하다.",
  ...
  },
  {
    ...
    "grade": "매수",
    "summary": "- 판정: 매수 - 리스크: 6/10 - 진입: 271,700원 ~ 286,000원 구간에서 3회 분할 매수",
    "kStockTemp": {
      "temp": 50,
      "status": "미지근/중립 (50°C)",
      "datetime": ""
    ...
    "factData": {
      ...
      "avg20dVolume": "706615주"
    },
    "subagentReports": {
      "growth": "현재가 286,000원 대비 컨센서스 목표주가 485,000원은 약 69.6%의 업사이드를 나타낸다. 글로벌 빅파마 기술이전 계약 마일스톤 및 신약 임상 가속화가 단기 실적 모멘텀을 지지하며, 미국 및 유럽 피하주사(SC) 제형 전환 파이프라인 확장로 중장기 매출 성장이 유효하다.",
      "cautious": "자산가치 대비 프리미엄이 붙어 있어 급격한 변동 장세에서 손실 위험이 있다. 추가 가격 조정 시점까지 보수적 관망을 권고한다.",
      "technical": "기관(-85,205주)과 외국인(+20,666주)의 수급 흐름이 단기 변곡점을 형성하고 있다. 거래량 481,793주가 실리며 이전 고점 대비 매물 소화 과정이 진행 중이므로, 지지선 이탈 여부를 확인하면서 눌림목 분할 진입이 유리하다.",
      "jurini": "초보자는 지금 사면 물리기 쉬우니 다음 기회를 기다릴 것"
    },
    "date": "2026-09-07",
    "time": "19:43:56",
  ...
  },
  {
    ...
    "grade": "매수",
    "summary": "- 판정: 매수 - 리스크: 6/10 - 진입: 373,350원 ~ 393,000원 구간에서 3회 분할 매수",
    "kStockTemp": {
      "temp": 50,
      "status": "미지근/중립 (50°C)",
      "datetime": ""
    ...
    "factData": {
      ...
      "avg20dVolume": "605663주"
    },
    "subagentReports": {
      "growth": "현재가 393,000원 대비 컨센서스 목표주가 701,600원은 약 78.5%의 업사이드를 나타낸다. 전방 산업 수주 잔고 증가 및 글로벌 수출 다변화가 단기 실적 모멘텀을 지지하며, 신흥 시장 진출 및 구조적 수요 증가 사이클로 중장기 매출 성장이 유효하다.",
      "cautious": "자산가치 대비 프리미엄이 붙어 있어 급격한 변동 장세에서 손실 위험이 있다. 추가 가격 조정 시점까지 보수적 관망을 권고한다.",
      "technical": "기관(+38,701주)과 외국인(+21,408주)의 수급 흐름이 단기 변곡점을 형성하고 있다. 거래량 431,118주가 실리며 이전 고점 대비 매물 소화 과정이 진행 중이므로, 지지선 이탈 여부를 확인하면서 눌림목 분할 진입이 유리하다.",
  ...
  },
  {
    ...
    "factData": {
      ...
      "pbr": "4.81배",
      "debtRatio": "45.95% (2025년 결산)",
      "avg20dVolume": "3919509주"
    },
    "subagentReports": {
      "growth": "현재가 1,783,000원 대비 컨센서스 목표주가 3,279,565원은 약 83.9%의 업사이드를 나타낸다. AI 데이터센터 증설에 따른 HBM 및 차세대 서버 메모리 공급 계약 확대가 단기 실적 모멘텀을 지지하며, 글로벌 AI 가속기 시장 연평균 30% 이상 성장 수혜로 중장기 매출 성장이 유효하다.",
      "cautious": "자산가치 대비 프리미엄이 붙어 있어 급격한 변동 장세에서 손실 위험이 있다. 추가 가격 조정 시점까지 보수적 관망을 권고한다.",
      "technical": "기관(+365,719주)과 외국인(+772,036주)의 수급 흐름이 단기 변곡점을 형성하고 있다. 거래량 3,478,577주가 실리며 이전 고점 대비 매물 소화 과정이 진행 중이므로, 지지선 이탈 여부를 확인하면서 눌림목 분할 진입이 유리하다.",
  ...
  },
  {
    ...
    "factData": {
      ...
      "pbr": "3.14배",
      "debtRatio": "29.94% (2025년 결산)",
      "avg20dVolume": "21836348주"
    },
    "subagentReports": {
      "growth": "현재가 270,000원 대비 컨센서스 목표주가 487,045원은 약 80.4%의 업사이드를 나타낸다. AI 데이터센터 증설에 따른 HBM 및 차세대 서버 메모리 공급 계약 확대가 단기 실적 모멘텀을 지지하며, 글로벌 AI 가속기 시장 연평균 30% 이상 성장 수혜로 중장기 매출 성장이 유효하다.",
      "cautious": "자산가치 대비 프리미엄이 붙어 있어 급격한 변동 장세에서 손실 위험이 있다. 추가 가격 조정 시점까지 보수적 관망을 권고한다.",
      "technical": "기관(+4,568,427주)과 외국인(+3,246,247주)의 수급 흐름이 단기 변곡점을 형성하고 있다. 거래량 18,277,791주가 실리며 이전 고점 대비 매물 소화 과정이 진행 중이므로, 지지선 이탈 여부를 확인하면서 눌림목 분할 진입이 유리하다.",
      "jurini": "한 번에 다 사지 말고, 주가가 조금 내릴 때마다 소액 분할 매수 권장"
    },
    "date": "2026-09-07",
    "time": "19:43:36",
