...
$cloudRunCmd = "gcloud run deploy madang3 --source . --region=$region --project=$project --update-env-vars=`"GEMINI_API_KEY=AIzaSyCy3gwd-OLOnW5A1hXnEYWprfEGaWFwF_I`" --allow-unauthenticated --quiet"
cmd /c $cloudRunCmd
